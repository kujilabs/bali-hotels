Refinery::Images.configure do |config|
  ...
  config.s3_bucket_name = BALI_SAFE_ENV['S3_BUCKET']
  config.s3_access_key_id = BALI_SAFE_ENV['S3_KEY']
  config.s3_secret_access_key = BALI_SAFE_ENV['S3_SECRET']
  config.s3_region = "ap-southeast-1"

  # Configure Dragonfly
  # This is where in the middleware stack to insert the Dragonfly middleware
  # config.dragonfly_insert_before = "ActionDispatch::Callbacks"
  # config.dragonfly_secret = "5816cc969de253908b9a9e1bf92adec49474275ad1c409c6"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "/Users/andy/projects/kujilabs/refinery/peninsular_bay/public/system/refinery/images"
